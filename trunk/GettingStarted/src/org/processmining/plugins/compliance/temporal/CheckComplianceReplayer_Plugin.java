...
import org.processmining.plugins.compliance.logprepare.GetLogFromControlFlowAlignment_Plugin;
...
public class CheckComplianceReplayer_Plugin {
	...
	@UITopiaVariant(
			...
			pack = "Compliance")
	@PluginVariant(variantLabel = "Check Temporal Compliance Using Data-Aware Conformance", requiredParameterLabels = { 0 })
	public Object[] replayLog(UIPluginContext context, PNRepResult replayRes) {
		...
		XLog abstractedLog = c.getObjectWithRole(PNRepResultAllRequiredParamConnection.LOG);
		...
		GetLogFromControlFlowAlignment_Plugin getLog = new GetLogFromControlFlowAlignment_Plugin();
		XLog properLog = getLog.getLogFromAlignment(context, replayRes);
